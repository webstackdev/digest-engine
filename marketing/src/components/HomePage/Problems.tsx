...
const Problems: FC<{
  ...
  return (
    <PageSection>
      <section className="border-t border-border bg-primary px-6 py-20 text-center text-primary-foreground">
      ...
      <section className="mx-auto max-w-7xl bg-background px-6 py-24 text-foreground">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="rounded-2xl border border-border bg-card p-8 transition-shadow hover:shadow-lg">
            ...
            <h4 className="mb-2 text-xl font-bold text-foreground">Peer-Endorsed Authority</h4>
          ...
          <div className="rounded-2xl border border-border bg-card p-8 transition-shadow hover:shadow-lg">
            <div className="mb-6 flex h-10 w-10 items-center justify-center rounded-lg bg-secondary font-bold text-primary">🌐</div>
            <h4 className="mb-2 text-xl font-bold text-foreground">Unified Profile Tracking</h4>
            <p className="text-sm leading-relaxed text-muted-foreground">
          ...
          <div className="rounded-2xl border border-border bg-card p-8 transition-shadow hover:shadow-lg">
            <div className="mb-6 flex h-10 w-10 items-center justify-center rounded-lg bg-secondary font-bold text-primary">🚨</div>
            <h4 className="mb-2 text-xl font-bold text-foreground">Competitive Guardrails</h4>
            <p className="text-sm leading-relaxed text-muted-foreground">
          ...
          <div className="rounded-2xl border border-border bg-card p-8 transition-shadow hover:shadow-lg">
            <div className="mb-6 flex h-10 w-10 items-center justify-center rounded-lg bg-secondary font-bold text-primary">🎯</div>
            <h4 className="mb-2 text-xl font-bold text-foreground">Personalized Algorithmic Training</h4>
            <p className="text-sm leading-relaxed text-muted-foreground">
          ...
          <div className="rounded-2xl border border-border bg-card p-8 transition-shadow hover:shadow-lg">
            <div className="mb-6 flex h-10 w-10 items-center justify-center rounded-lg bg-secondary font-bold text-primary">📈</div>
            <h4 className="mb-2 text-xl font-bold text-foreground">Macro Trend Trajectories</h4>
            <p className="text-sm leading-relaxed text-muted-foreground">
          ...
          <div className="rounded-2xl border border-border bg-card p-8 transition-shadow hover:shadow-lg">
            ...
            <h4 className="mb-2 text-xl font-bold text-foreground">Zero Database Complexity</h4>
            <p className="text-sm leading-relaxed text-muted-foreground">
