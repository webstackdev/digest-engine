...
OPENROUTER_APP_NAME = os.getenv("OPENROUTER_APP_NAME", "digest-engine")
AI_CLASSIFICATION_MODEL = os.getenv(
...
AI_CLASSIFICATION_REVIEW_THRESHOLD = env_float(
    "AI_CLASSIFICATION_REVIEW_THRESHOLD", default=0.6
)
...
AI_RELEVANCE_SUMMARIZE_THRESHOLD = env_float(
    "AI_RELEVANCE_SUMMARIZE_THRESHOLD", default=0.7
)
