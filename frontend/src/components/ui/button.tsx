...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center rounded-lg border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all select-none active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-danger aria-invalid:ring-3 aria-invalid:ring-danger [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-inverse hover:bg-primary hover:shadow-soft aria-expanded:bg-primary",
        outline:
          "border-trim-offset bg-page-base hover:bg-page-offset hover:text-content-active aria-expanded:bg-page-offset aria-expanded:text-content-active",
        secondary:
          "bg-secondary text-secondary-inverse hover:bg-secondary aria-expanded:bg-secondary aria-expanded:text-secondary-inverse",
        ghost:
          "hover:bg-page-offset hover:text-content-active aria-expanded:bg-page-offset aria-expanded:text-content-active",
        destructive:
