    ...
    <section className="mb-4 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
      ...
      <Card className="rounded-3xl border border-trim-offset bg-page-base shadow-panel backdrop-blur-xl">
        <CardContent className="pt-5">
          ...
          <p className="text-sm leading-6 text-content-offset">Theme-backed sections in this edition.</p>
        </CardContent>
      </Card>
      <Card className="rounded-3xl border border-trim-offset bg-page-base shadow-panel backdrop-blur-xl">
        <CardContent className="pt-5">
          ...
          <p className="text-sm leading-6 text-content-offset">Accepted original ideas carried into the draft.</p>
        </CardContent>
      </Card>
      <Card className="rounded-3xl border border-trim-offset bg-page-base shadow-panel backdrop-blur-xl">
        <CardContent className="pt-5">
