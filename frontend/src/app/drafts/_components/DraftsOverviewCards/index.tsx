    ...
    <section className="mb-4 grid gap-4 sm:grid-cols-2 xl:grid-cols-5">
      <Card className="rounded-3xl border border-trim-offset bg-page-base shadow-panel backdrop-blur-xl">
        <CardContent className="pt-5">
          ...
          <p className="text-sm leading-6 text-content-offset">Drafts currently being composed.</p>
        </CardContent>
      </Card>
      <Card className="rounded-3xl border border-trim-offset bg-page-base shadow-panel backdrop-blur-xl">
        <CardContent className="pt-5">
          ...
          <p className="text-sm leading-6 text-content-offset">Drafts ready for editorial review.</p>
        </CardContent>
      </Card>
      <Card className="rounded-3xl border border-trim-offset bg-page-base shadow-panel backdrop-blur-xl">
        <CardContent className="pt-5">
          ...
          <p className="text-sm leading-6 text-content-offset">Drafts with local editorial changes.</p>
        </CardContent>
      </Card>
      <Card className="rounded-3xl border border-trim-offset bg-page-base shadow-panel backdrop-blur-xl">
        <CardContent className="pt-5">
          ...
          <p className="text-sm leading-6 text-content-offset">Drafts marked published in the backend.</p>
        </CardContent>
      </Card>
      <Card className="rounded-3xl border border-trim-offset bg-page-base shadow-panel backdrop-blur-xl">
        <CardContent className="pt-5">
          ...
          <p className="text-sm leading-6 text-content-offset">Drafts that ended in an error state.</p>
        </CardContent>
      </Card>
    </section>
  )
