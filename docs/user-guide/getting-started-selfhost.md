...
## Logging In
Navigate to the URL provided by your IT Administrator. You can log in using your provided Username/Password, or if configured, via Single-Sign On (like LinkedIn).

## What Your Admin Configured
...
## Next Steps
Head to [Projects and Content](projects-and-content.md) to learn how to curate the resulting article feed.
